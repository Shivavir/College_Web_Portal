<html>
  ...
  <body>
	...
	<div id="main" class="row"  style="min-height:500px;padding:25px;">
	 <div class="col-sm-12 text-center h1 page-heading" style="background-color:#CACFD2">Log In</div>
	 ...
	 <div class="row">
	   ...
	   <form action="validateLogin.jsp" method="post">
		 ...
		 <div class="row">
	   <div class="col-sm-3" style="padding-top:9px; font-size:16px;">User Type:- </div>
	   <div class="col-sm-9">
	  <select name="utype" id="utype" class="form-control">
	   ...
	   <option value="admin"> Admin </option>
		...
		<div class="row" style="margin-top:20px;">
		   <div class="col-sm-3" style="padding-top:9px; font-size:16px;">User Id:-</div>
		<div class="col-sm-9">
		...
		<div class="row" style="margin-top:20px;">
		   <div class="col-sm-3" style="padding-top:9px; font-size:16px;">User Password:-</div>
		<div class="col-sm-9">
		...
		<input type="password" id="userpass" name="upwd" class="form-control" placeholder= "passward" /></div>
		 ...
		 <a style="color:skyblue;" href="#"><b> Forgot password ?....</b></a>
		 
		 </div>
		
		  <div class="col-sm-4">
		  new user:- &nbsp;&nbsp;<a style="color:skyblue; " href="registration.jsp"><b> Sign up</b> </a>
		 </div>
		 </div>
